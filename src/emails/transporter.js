...
// transporter.js
//
// Punto unico para construir y reutilizar el transporter SMTP.
// Nodemailer recomienda reutilizar el transporter en vez de crearlo por mail.
// ============================================================================
...
function getResolvedMailConfig() {
  ...
  // Evitamos mezclar dos juegos de credenciales en silencio.
  // Si ambos estan definidos al mismo tiempo, es mejor fallar con un mensaje claro.
