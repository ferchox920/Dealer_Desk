...
function validateUpdateListing(req, res, next) {
  ...
  if (!id || !Number.isInteger(id) || id < 1) {
    errors.push({ code: 'LISTING_ID_INVALID', field: 'id', message: 'The id must be a valid positive integer.' });
  }

  // Reutilizar las mismas validaciones de tipos del body
  const body = req.body;
...
export { validateCreateListing, validateUpdateListing };
