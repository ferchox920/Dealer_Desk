...
// rate-limiters.js
//
// Limitadores chicos y explicitos para endpoints sensibles de auth.
// No intentan resolver todos los escenarios del mundo; solo ponen freno a:
//  - fuerza bruta de login
//  - spam de correos
//  - abuso de enlaces de setup/reset
// ============================================================================
