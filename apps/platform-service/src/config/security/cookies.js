const REFRESH_TOKEN_COOKIE_NAME = 'dealer_desk_platform_refresh_token';
...
function getRefreshCookieOptions() {
  const refreshDays = Number(process.env.PLATFORM_REFRESH_TOKEN_TTL_DAYS || process.env.REFRESH_TOKEN_TTL_DAYS || 30);
